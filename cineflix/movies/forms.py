...
class MovieForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'video':forms.TextInput({'class':'form-control','type':'url','placeholder':'Enter Video URL'}),

            'tags':forms.Textarea({'class':'form-control','rows':3,'placeholder':'Enter Tags with #'}),

            'languages':forms.SelectMultiple({'class':'form-select'})
        }
