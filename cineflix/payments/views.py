...
class PaymentVerifyView(View):
    ...
    def post(self,request,*args,**kwargs):
        ...
        if paid :
            ...
            usersubscriptions = transaction_obj.user_subscription
            ...
            usersubscriptions.end_date = end_date

            usersubscriptions.active = True
        ...
        return redirect('razorpay',uuid = usersubscriptions.plan.uuid)